...
export default function Client() {
  ...
  return (
    <>
      ...
      <ToolGrid>
        <InputPanel share="a" openFile label="Original" value={left} onChange={setLeft} rows={12} />
        <InputPanel share="b" openFile label="Changed" value={right} onChange={setRight} rows={12} />
      </ToolGrid>
